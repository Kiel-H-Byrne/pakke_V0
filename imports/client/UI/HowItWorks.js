                ...
                <Paper style={styles.paper}>
                    ...
                    <Grid container justify={'center'} style={{ marginTop: '1%' }}>
                        ...
                        <Grid item style={styles.box0}>
                            ...
                            <Typography align={'center'} style={styles.box2} variant="headline">Its free to apply. Just sign in. Apply up until the day before or tickets sell out</Typography>
                        </Grid>
                        ...
                        <Grid item style={styles.box0}>
                            ...
                            <hr style={styles.divider} />
                            <Typography align={'center'} style={styles.box2} variant='headline'>Selections are made using a lottory system. Once you are selected, you'll receive an email to purchase your ticket</Typography>
                        </Grid>
                        ...
                        <Grid item style={styles.box0}>
                            ...
                            <Typography align={'center'} style={styles.box2} variant='headline'>Purchase your ticket for yourself and your friends. Then we'll email you the event location the day before the event</Typography>
                        </Grid>
