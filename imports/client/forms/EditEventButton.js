 ...
 class EditEventButton extends Component {
  ...
  cancelEvent = () => {
    ...
    const omitFields = ["submitted", "venue", "hostId", "categories", "appliedList", "invitedList", "confirmedList", "entertainers", "partner", "featured"];
		...
		return (
			<div>
	    <Fab size="small" aria-label="edit" color="secondary" className={classes.button} onClick={this.handleOpen}><EditIcon /></Fab> 
			<Modal 
      ...
      > 
        <div className={classes.paper + ' scroll-wrapper-y'}>
          <Typography variant="h3" align="center" id="eventPurchaseModal">Edit Event:</Typography>
          <AutoForm  
  	      schema={Schema.Event} 
